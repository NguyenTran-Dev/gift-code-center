  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#0a0a0a]">
      ...
      <main className="container mx-auto flex-1 px-4 py-8 sm:px-6 lg:px-8">
        <Link 
          href="/" 
          className="inline-flex items-center gap-2 text-sm text-gray-400 hover:text-cyan-400 mb-8 transition-colors group"
        >
          ...
          <div className="relative flex flex-col items-center gap-8 p-8 md:flex-row md:p-12">
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="flex flex-wrap items-center justify-center gap-3 mb-4 md:justify-start">
                <Badge className="bg-cyan-500/20 text-cyan-400 border-none px-4 py-1">
                  {game.category}
                </Badge>
              ...
              <h1 className="text-4xl font-extrabold text-white sm:text-5xl lg:text-6xl mb-4 italic uppercase">
                {game.name}
              </h1>
              <p className="max-w-2xl text-lg text-gray-400 mb-8">
                {game.description || `Chào mừng bạn đến với ${game.name}. Tại đây bạn có thể tìm thấy toàn bộ giftcode mới nhất và giá trị nhất.`}
              </p>
              
              <div className="flex flex-wrap items-center justify-center gap-4 md:justify-start">
                 <Button className="bg-cyan-600 hover:bg-cyan-500 text-white gap-2 rounded-xl h-12 px-8 font-bold">
                    <Gift className="h-5 w-5" />
                    NHẬN CODE NGAY
                 </Button>
                 <Button variant="outline" className="border-white/10 text-white hover:bg-white/5 gap-2 rounded-xl h-12 px-8">
        ...
        <section className="mb-20">
          ...
          {game.giftcodes.length > 0 ? (
            ...
            <div className="rounded-3xl border border-dashed border-white/10 p-12 text-center bg-white/5">
               ...
               <h3 className="text-xl font-bold text-white mb-2">Chưa có giftcode nào</h3>
               <p className="text-gray-400">Chúng tôi đang cập nhật giftcode cho game này. Quay lại sau nhé!</p>
            </div>
          )}
        </section>
      </main>
